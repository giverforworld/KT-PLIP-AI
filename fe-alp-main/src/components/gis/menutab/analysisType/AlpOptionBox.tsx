...
import LifestylePatternFilter from "../newfilter/LifestylePatternFilter";
...
export default function AlpOptionBox({
	mapIdx = 0,
	gisSettings,
	setGisSettings,
	tempSettings,
	...
	setDate,
	defaultDate,
}: Readonly<AlpOptionBoxProps>) {
	// const [queryDate, setQueryDate] = React.useState(defaultDate);
	...
	return (
		<>
			...
			>
				...
				/>
				{tempSettings.gridScale !== 0.05 && (
					<LifestylePatternFilter
