...
export default function BaseTextarea<T extends Record<string, any>>({
	placeholder,
	name,
	label,
	rows = 3,
	...
	return (
		<div className="mb-4">
			...
			<textarea
				className={`w-full resize-none appearance-none rounded-md border bg-[#fbfbfb] p-2 text-sm placeholder:text-sm ${
