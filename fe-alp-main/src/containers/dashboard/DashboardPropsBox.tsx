...
import DashboardContainerProps from "./DashboardContainerProps"

export default function DashboardPropsBox() {
    ...
    return startEnd && <DashboardContainerProps startEnd={startEnd} />
}