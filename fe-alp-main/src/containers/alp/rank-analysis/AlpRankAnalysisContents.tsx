...
export default function AlpRankAnalysisContents() {
	...
	const { data, isLoading: isRankingLoading } = useRankingQuery(searchQueryParams, "alp");

	useEffect(() => {
		if (!_.isEmpty(selectedFilters)) {
			setSearchQueryParams(
				generateRankingQueryParams(searchFilter, selectedFilters, activeToggle, "alp"),
			);
		}
	}, []);
