...
import LlpStatusContents from "./LlpStatusContents";
...
export default function LlpStatusContainerBox({startEnd}: DashboardProps) {
    let dataInfo;
    ...
    return regionInfo && <LlpStatusContents regionInfo={regionInfo} />;
}